...
- **Core**: MIT License (see [LICENSE](../../../cli-agents/openhands/LICENSE))
- **Enterprise**: Polyform Free Trial License (30-day limit, see [enterprise/LICENSE](../../../cli-agents/openhands/enterprise/LICENSE))
