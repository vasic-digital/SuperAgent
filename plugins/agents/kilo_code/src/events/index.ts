/**
 * HelixAgent Event Module for Kilo-Code
 *
 * Provides real-time event subscription via SSE and WebSocket.
 */
...
export function createEventClient(endpoint: string, opts?: SubscriptionOptions): EventClient {
