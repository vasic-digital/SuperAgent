...
/**
 * HelixAgent Protocol Enhancement CLI
 * Command-line interface for HelixAgent Protocol Enhancement
 *
 * @version 1.0.0
 * @author HelixAgent
 * @license MIT
...
class HelixAgentCLI {
    constructor() {
        this.baseURL = process.env.HELIXAGENT_URL || 'http://localhost:8080';
        this.apiKey = process.env.HELIXAGENT_API_KEY || null;
        this.timeout = 30000;
    }
    ...
    async request(endpoint, options = {}) {
        ...
        const config = {
            ...
            headers: {
                ...
                'User-Agent': 'HelixAgent-CLI/1.0.0'
            },
...
function printUsage() {
    console.log(`
HelixAgent Protocol Enhancement CLI v1.0.0

USAGE:
    helixagent-cli <command> [options]
