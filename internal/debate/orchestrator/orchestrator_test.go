...
func TestDefaultOrchestratorConfig(t *testing.T) {
	...
	// 5 positions × 3 LLMs = 15 agents (as documented in DefaultOrchestratorConfig)
	assert.Equal(t, 15, config.MinAgentsPerDebate)
	assert.Equal(t, 25, config.MaxAgentsPerDebate)
