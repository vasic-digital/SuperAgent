...
var SupportedProviders = map[string]*ProviderTypeInfo{
	...
	"huggingface": {
		...
		Tier:        3,
		Priority:    5,
		EnvVars:     []string{"HUGGINGFACE_API_KEY", "HF_API_KEY"},
	...
	"cloudflare": {
		...
		Tier:        4,
		Priority:    5,
		EnvVars:     []string{"CLOUDFLARE_API_KEY", "CF_API_KEY"},
	...
	"upstage": {
		...
		Tier:        3,
		Priority:    4,
		EnvVars:     []string{"UPSTAGE_API_KEY"},
	...
	"nlpcloud": {
		...
		Tier:        4,
		Priority:    5,
		EnvVars:     []string{"NLP_API_KEY", "NLPCLOUD_API_KEY"},
	...
	"modal": {
		...
		Tier:        4,
		Priority:    5,
		EnvVars:     []string{"MODAL_API_KEY", "MODAL_TOKEN_SECRET"},
	...
	"inference": {
		...
		Tier:        4,
		Priority:    5,
		EnvVars:     []string{"INFERENCE_API_KEY"},
	...
	"hyperbolic": {
		...
		Tier:        3,
		Priority:    4,
		EnvVars:     []string{"HYPERBOLIC_API_KEY"},
	...
	"vulavula": {
		...
		Tier:        4,
		Priority:    6,
		EnvVars:     []string{"VULAVULA_API_KEY"},
	...
	"codestral": {
		...
		Tier:        2,
		Priority:    2,
		EnvVars:     []string{"CODESTRAL_API_KEY"},
